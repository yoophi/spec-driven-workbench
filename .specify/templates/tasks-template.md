...
### Tests or Manual Checks for User Story 1
...
- [ ] TXXX Verify spec-related documents use Korean prose except technical terms and code
...
- Avoid: traffic-scale optimization without a measured personal-use bottleneck
