...
- **SC-002**: [Measurable responsiveness metric for personal use, e.g., "Primary action feedback appears within 200ms locally"]
...
- [Personal-project scope assumption, e.g., "Traffic-scale optimization is out of scope unless measured locally"]
